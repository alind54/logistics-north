...
export default function StageColumn({ stage, requests, canMoveBackward, canMoveForward, onMove, onEdit, onDelete, onArchive, attachmentCounts }: StageColumnProps) {
    ...
    <div className="bg-gray-50/80 rounded-xl overflow-hidden border border-gray-200/60">
      ...
      <Droppable droppableId={stage.id}>
        {(provided, snapshot) => (
          <div
            ...
            className={`p-3 transition-colors ${snapshot.isDraggingOver ? 'bg-blue-50/50' : ''}`}
          >
      ...
      {expanded && hasOverflow && (
        <button
          ...
          className="w-full flex items-center justify-center gap-1 px-3 py-1.5 text-gray-500 text-xs font-medium hover:bg-gray-100 transition-colors border-t border-gray-200"
        >
